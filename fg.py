...
async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='listening !help', type=2))
        ...
        await asyncio.sleep(20)
        await client.change_presence(game=discord.Game(name='listening !help2', type=2))
        await asyncio.sleep(20)
        await client.change_presence(game=discord.Game(name='listening !help3', type=2))
        await asyncio.sleep(20)
...
async def on_ready():
     ...
     print('.......')
     print('created by gamer sahil and bluebird')
     client.loop.create_task(status_task())


def is_owner(ctx):
     return ctx.message.author.id in ["455322915471097857","456693052468101120"]
...
async def setw(ctx):
    ...
    if ctx.message.author.server_permissions.administrator == False:
      ...
      await client.create_channel(server, 'wélcome',everyone)
